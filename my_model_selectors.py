    ...
    def select(self):
        ...
        for n_components in range(self.min_n_components,self.max_n_components+1 ):
            try:
                ...
                bicScore = -2*hmm_model.score(self.X, self.lengths) + 2*n_components
                if(bicScore<bestScore):
                    bestScore = bicScore
                    bestModel = hmm_model
        ...
        for n_components in range(self.min_n_components,self.max_n_components+1 ):
            try:
                ...
                for word in allWords:
                    ...
                    allLog.append(hmm_model.score(Y, Ylengths))
                
                dicScore = hmm_model.score(self.X, self.lengths) -sum(allLog)/len(allLog)
